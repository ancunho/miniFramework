...
import com.mini.framework.annotation.Impl;
...
public class IocHelper {
    ...
    static {
        try {
                        ...
                        if (beanField.isAnnotationPresent(Inject.class)) {
                            ...
                            if (implementClass != null) {
                                ...
                                if (implementInstance != null) {
                                    ...
                                    throw new Error("依赖注入失败！类名：" + beanClass.getSimpleName() + "，字段名：" + interfaceClass.getSimpleName());
                                }
                            }
                        }
                    }
            ...
            throw new Error("初始化 IocHelper 出错！", e);
        }
    }
