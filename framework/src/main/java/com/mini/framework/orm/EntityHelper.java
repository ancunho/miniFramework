package com.mini.framework.orm;

import com.mini.framework.core.ClassHelper;
import com.mini.framework.orm.annotation.Column;
import com.mini.framework.orm.annotation.Entity;
import com.mini.framework.orm.annotation.Table;
...
public class EntityHelper {
    ...
    public static Map<String, String> getColumnMap(Class<?> entityClass) {
        ...
        if (MapUtils.isNotEmpty(getFieldMap(entityClass))) {
            target = new LinkedHashMap<String, String>(getFieldMap(entityClass).size());
            for (Map.Entry<String, String> entry : getFieldMap(entityClass).entrySet()) {
